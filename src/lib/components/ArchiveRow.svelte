...
>
  <div class="min-w-0">
    ...
    <Eyebrow tone="accent" tracking="0.06em">{post.category}</Eyebrow>
  </div>
  <div class="flex-none text-right font-mono text-[11px] whitespace-nowrap text-faint-2">
    {shortDate(post.date)} · {post.readTime}
  </div>
</a>
